...
public class dataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        nom1.setSueldoBase(650000.0);
        nom1.setBonos(80000.0);
        nom1.setDescuentos(45000.0);

        nom1.setSueldoLiquido(685000.0);
        nom1.setFechaEmision(LocalDate.now().minusMonths(1));
        nom1.setEmpleadoId(1L);


        ModeloNomina nom2 = new ModeloNomina();
        nom2.setSueldoBase(850000.0);
        nom2.setBonos(120000.0);
        nom2.setDescuentos(65000.0);
        nom2.setSueldoLiquido(905000.0);
        nom2.setFechaEmision(LocalDate.now());
        nom2.setEmpleadoId(2L);
