...
public class ServicioCategoria {
    ...
    public ModeloCategoria guardarCategoria(categoriaDTO dto) {
        ...
        repositoryCategoria.findByNombreCategoria(dto.getNombreCategoria()).ifPresent(c -> {
    ...
    public ModeloCategoria actualizarCategoria(Long id, categoriaDTO dto) {
        ...
        repositoryCategoria.findByNombreCategoria(dto.getNombreCategoria()).ifPresent(otra -> {
